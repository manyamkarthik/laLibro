  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
        <div className="text my-5">
            ...
            <p className="text-2xl my-7 px-1 dark:text-slate-300"><b>La Libro</b> is your ultimate destination for exploring a wide variety of digital books. Discover ratings, reviews, and access the latest releases across multiple genres and languages, all at your fingertips—<b>libros</b> for everyone, everywhere.</p>
